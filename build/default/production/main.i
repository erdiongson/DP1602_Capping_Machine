...
volatile int error_digit=1;
volatile int units, tens, hundreds, thousands;
volatile int EAdd_High, EAdd_Low, Edigit=0;
volatile int TotalNum_HighH, TotalNum_HighL, TotalNum_LowH, TotalNum_LowL;
volatile int Temp;
volatile int TempNum;
volatile int startup = 1;

volatile char OpMode = MANUAL_MODE;
volatile char error_number = '0';
volatile char warning_number = '0';
volatile char update_7seg = !1;
volatile char TMR0IF_triggered = !1;
volatile char TMR1IF_triggered = !1;
volatile char TMR2IF_triggered = !1;
volatile char error = 0;
volatile char warning = 0;
volatile char FeederRotate1 = 0;
volatile char FeederRotate2 = 0;

volatile long error1counter = 50;
volatile long error2counter = 30;
volatile long error3counter = 30;
volatile long error4counter = 30;
volatile long error5counter = 30;
volatile long error6counter = 30;

unsigned int LiftUpHoldCounter = 5;

volatile int sw1counter = 20;
volatile int LiftUpTime = 50;
volatile int FeederRotate1Time = 50;
volatile int FeederRotate2Time = 50;
...
void main(void)
{
unsigned int sol_activation_on_time = 30;
unsigned int sol_activation_off_time = 50;
...
TotalNum_HighH = 0x0080;
TotalNum_HighL = 0x0070;

TotalNum_LowH = 0x00A0;
TotalNum_LowL = 0x0090;

number = read_i2c(EAdd_High);
number *= 0x100;
number += read_i2c(EAdd_Low);

TotalNumL = read_i2c(TotalNum_LowH);
TotalNumL *= 0x100;
TotalNumL += read_i2c(TotalNum_LowL);

TotalNumH = read_i2c(TotalNum_HighH);
TotalNumH *= 0x100;
TotalNumH += read_i2c(TotalNum_HighL);
...
# 236
INTCONbits.GIE=0;
sol_on_time = read_i2c(0x0010);
sol_off_time = read_i2c(0x0020);
lift_up_hold_time = read_i2c(0x0030);
lifter_up_position = read_i2c(0x0040);
INTCONbits.GIE=1;
...
LiftUpHoldCounter=5;
INTCONbits.GIE=0;
write_i2c(0x0030, lift_up_hold_time);
INTCONbits.GIE=1;
}
else
{
...
INTCONbits.GIE=0;
write_i2c(0x0040, lifter_up_position);
INTCONbits.GIE=1;
}
else
{
...
} while(PORTDbits.RD1 == 0 && PORTDbits.RD2 == 1);
...
if ((PORTDbits.RD2) && (start_capping == 1) && (error == 0))
{
LATBbits.LATB3 = 1;
}

else if ((!PORTDbits.RD2) || (start_capping == 0) || (error == 1))
{
LATBbits.LATB3 = 0;


if(!PORTDbits.RD2 && lifter == standby)
{
...
# 566
if(PORTDbits.RD1 == 0 && PORTDbits.RD2 == 1 && lifter == standby)
{
if(PORTDbits.RD1 ==0)
{
LATBbits.LATB3 = 1;
...
if((PORTBbits.RB0 == 1) && (PORTDbits.RD3 ==1) && (Busy == 0))
{
_delay((unsigned long)((50)*(8000000/4000.0)));
if(PORTBbits.RB0 == 1)
{
...
} while((PORTDbits.RD1 == 0) && (PORTDbits.RD2 == 1) &&(lifter == standby));
...
else if(PORTDbits.RD1 == 1 && lifter == standby)
{
capin = 1;
}
...
Busy = 1;
INTCONbits.GIE=0;
num1 = read_i2c(0x0090);
num2 = read_i2c(0x00A0);
num3 = read_i2c(0x0070);
num4 = read_i2c(0x0080);
...
if((PORTDbits.RD0)&&(!PORTEbits.RE7))
{
DelayTime_1ms(300);
lifter = moveup;
Lifter_Up();
...
{
if(PORTEbits.RE7 && error5counter == 0)
{
error = 1;
error_number = '5';
lifter = standby;
...
void CapFillingStart (void)
{
if(FeederRotate1 == 1 && FeederRotate2 == 0)
{
if(FeederRotate1Time == 0)
{
Feeder_Stop();
...
FeederRotate1 = 0;
FeederRotate2 = 0;
FeederRotate1Time = 50;
FeederRotate2Time = 50;
}
